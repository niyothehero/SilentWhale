...
const plans = [
  {
    name: "Free",
    description: "For public signal discovery",
    price: { monthly: 0, annual: 0 },
    features: [
      "Delayed public summaries",
      "Protocol status",
      "Landing intelligence",
      "No private decrypt access",
      "Upgrade any time",
    ],
    cta: "Open dashboard",
    href: "/dashboard",
  ...
  {
    name: "Pro",
    description: "For live encrypted alerts",
    price: { monthly: 0.001, annual: 0.001 },
    features: [
      "Live signal unlocks",
  ...
  {
    name: "DAO",
    description: "For team intelligence desks",
                  ...
                  <div className="mb-8">
                    {plan.price.monthly !== null ? (
                      <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-muted-foreground text-sm"> ETH/month</span>
                      </div>
                    ) : (
                    ...
                    {plan.price.monthly !== null && plan.price.monthly > 0 && (
                      <p className="text-xs text-muted-foreground mt-2 font-mono">
                        {isAnnual ? "contract default" : "monthly"}
                      </p>
                    )}
                  </div>
