...
const footerLinks = {
  Product: [
    { name: "Signal dashboard", href: "/dashboard" },
    { name: "Analyst console", href: "/analyst" },
    { name: "Private watchlists", href: "/watchlist" },
    { name: "Access tiers", href: "/subscription" },
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-12 lg:gap-8">
            ...
            <div className="col-span-2">
              ...
              <p className="text-white/50 leading-relaxed mb-8 max-w-xs text-sm">
                Private whale intelligence with encrypted signals, on-chain subscriptions, and local decrypt permissions.
              </p>
        ...
        <div className="py-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/30">
            &copy; 2026 SilentWhale. All rights reserved.
          </p>
