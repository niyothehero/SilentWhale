...
const steps = [
  {
    ...
    description: "An analyst encrypts sensitive values locally and writes the ciphertext handles to the SilentWhale contract.",
    code: `await silentWhale.publishSignal(
  feedId,
  publicSummary,
  encryptedWhale,
  encryptedAmount
  ...
  },
  {
    ...
    title: "Subscribe",
    subtitle: "on-chain",
    description: "A subscriber buys a Pro, Elite, or DAO tier. The contract checks active access before granting ACL permissions.",
    code: `await silentWhale.subscribe(
  Tier.Pro,
  1,
  { value: price }
)`,
  },
  {
    number: "03",
    title: "Decrypt",
    subtitle: "with permit",
    description: "The subscriber requests access, signs a permit, and sees plaintext locally without publishing the secret on-chain.",
    code: `await client
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block text-white/10">Decrypt.</span>
            </h2>
          </div>
